...
class Artist extends DomainObject{
   ...
   public function __construct($data){
    ...
    public function getThumbnail(){
    	$name = $this->getFullName(false);
    	return '<img class="artist-thumb" src="images/art/artists/square-thumb/'.$this->ArtistID.'.jpg" title="'.$name.'" alt="'.$name.'">';
    }
    ...
    public function createArtistWorks(){
    	...
    	foreach($this->works as $painting){
    		$works .= "<div class='ui column'>" . $painting->createThumbnail() . "</div>";
    	}
    	return $works;
